    ...
    <div style="display: flex;flex-direction: column;">
        ...
        <div class="display">
            <img width="24" height="24" src="https://img.icons8.com/color/48/python--v1.png" alt="python--v1"
                style="margin-top: 1%;" />
            <p id="p1" style="margin-left: 1%;">Python</p>
        </div>
        <div class="display"><img width="24" height="24" src="https://img.icons8.com/nolan/64/html-5.png" alt="html-5"
                style="margin-top: 1%;" />
            <p id="p1" style="margin-left: 1%;">HTML 5</p>
        </div>
        <div class="display">
            <img width="24" height="24" src="https://img.icons8.com/color/48/css3.png" alt="css3"
                style="margin-top: 1%;" />
            <p id="p1" style="margin-left: 1%;">CSS 3</p>
        </div>
        <div class="display">
            <img width="24" height="24"
                src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/24/external-linux-a-family-of-open-source-unix-like-operating-systems-based-on-the-linux-kernel-logo-color-tal-revivo.png"
